      ...
      <div class="col-sm-3">
        <h4>
          <div class="list-group">
            ...
            <router-link to="/user/gameHelp" type="button" class="list-group-item">游戏帮助</router-link>
           <!-- <router-link to="/user/feedback" type="button" class="list-group-item">意见反馈</router-link>
        -->  </div>
        </h4>
      </div>
